            ...
            <div style="border:1px solid black;">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="grade">
                                <option value="Grade 1" <?php if (isset($_POST['reg']) && $_POST['grade'] == 'Grade 1')  echo ' selected';?>>Grade 1</option>
                                <option value="Grade 2" <?php if (isset($_POST['reg']) && $_POST['grade'] == 'Grade 2')  echo ' selected';?>>Grade 2</option>
                                <option value="Grade 3" <?php if (isset($_POST['reg']) && $_POST['grade'] == 'Grade 3')  echo ' selected';?>>Grade 3</option>
                            </select>
                        </td>
                    </tr>
                    <tr height="40px">
